...
public class FaithTrackTest {
    ...
    void testOnePlayerTile1True() {
        ...
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile1()); // The first tile
        assertEquals(2, GameBoard.getGameBoard().getFaithTracks().size());
    ...
    void testOnePlayerWithAllThePopeTileFlippedUp() {
        ...
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile1()); // The first tile
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile2()); // The secondo tile
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile3()); // The third tile
    ...
    void testTwoTileTrueOfFourPlayers() {
        ...
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile1()); // The Roronoa's tile is flipped up
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(1)).isPopeTile1()); // The Monkey's tile is flipped up
        assertFalse(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(2)).isPopeTile1()); // The Nico's tile is not flipped up
        assertFalse(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(3)).isPopeTile1()); // The Vinsmoke's tile is not flipped up
    ...
    void testOneTimeFlippedUpTheSameTile() {
        ...
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile1()); // The Roronoa's tile is flipped up
        assertFalse(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(1)).isPopeTile1()); // The Monkey's tile is not flipped up
    ...
    void testAllPlayersExceptOneProgress() {
        ...
        assertFalse(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(0)).isPopeTile1()); // The Roronoa's tile is not flipped up
        assertFalse(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(1)).isPopeTile1()); // The Monkey's tile is not flipped up
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(2)).isPopeTile1()); // The Nico's tile is flipped up
        assertTrue(GameBoard.getGameBoard().getFaithTrackOfPlayer(players.get(3)).isPopeTile1()); // The Vinsmoke's tile is flipped up
