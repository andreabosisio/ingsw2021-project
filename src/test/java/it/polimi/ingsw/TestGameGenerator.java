...
public class TestGameGenerator {
     ...
     */
    public void roundOfNothing(ModelInterface modelInterface) throws InvalidIndexException, InvalidEventException, EmptySlotException, NonAccessibleSlotException {
        for (int i = 0; i < 3; i++) {
